...
// // Use ResizeObserver so it reacts to the container's actual size changes,
// // not just window resizes — fixes the canvas getting "stuck" at whatever
// // size the container happened to be on first mount.
// const resizeObserver = new ResizeObserver(() => resize());
// resizeObserver.observe(container);

// Run once after layout settles, in case initial mount size was 0 or wrong
